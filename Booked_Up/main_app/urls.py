...
urlpatterns = [
   ...
   path('accounts/signup/', views.signup, name='signup'),
   path('books/<int:book_id>/comments/', views.comments_index, name='comment-index'),
   path('books/<int:book_id>/comments/<int:comment_id>/', views.comment_detail, name='comment-detail'),
